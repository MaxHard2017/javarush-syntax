...
public class FileContentVizit1 extends SimpleFileVisitor<Path> {
    ...
    long i = 0; 
    public FileContentVizit1(Map<String, Path> fileInfo, 
    ...
    public FileVisitResult visitFile(Path file, BasicFileAttributes attr) {
        ...
        String key = FileHash.get(file, "MD5");
        // String key = FileHash.getCRC(file, "CRC32C");
